...
class sbBox(connectBox):
    ...
    def runFile(self) -> None:
        ...
        self.updateStatus('Running SBP file ' + self.sbpName, True)
    ...
    def waitForStart(self) -> None:
        ...
        self.updateStatus('Waiting to start file, Shopbot output flag = ' + str(sbFlag) + ', start at ' + str(self.critFlag), False)
